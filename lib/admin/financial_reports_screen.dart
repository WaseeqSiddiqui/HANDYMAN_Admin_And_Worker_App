...
class FinancialReportsScreenState extends State<FinancialReportsScreen> {
  ...
  Widget _fixedAvgCard(FinancialReportSummary report) {
    final t =
    AdminTranslations.split(AdminTranslations.avgServiceValue);
        ...
        Expanded(
          child: _quickCard(
            ...
            Colors.orange,
                ...
                context,
                MaterialPageRoute(
                    builder: (_) => const VATManagementScreen())),
            cardColor,
            textColor,
          ),
        ),
  ...
  Widget _quickCard(String key, String amount, IconData icon, Color color,
      VoidCallback onTap, Color cardColor, Color textColor) {
